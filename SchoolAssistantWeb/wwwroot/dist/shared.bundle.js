(this["webpackChunkschoolassistant"] = this["webpackChunkschoolassistant"] || []).push([["shared"],{
...
/***/ "./React/shared/components/buttons/buttons.css":
/*!*****************************************************!*\
  !*** ./React/shared/components/buttons/buttons.css ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./React/shared/form-controls/form-controls.css":
/*!******************************************************!*\
  !*** ./React/shared/form-controls/form-controls.css ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./React/shared/form-controls/label-value.css":
/*!****************************************************!*\
  !*** ./React/shared/form-controls/label-value.css ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./React/shared/modals/modals.css":
/*!****************************************!*\
  !*** ./React/shared/modals/modals.css ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
exports.V = V;
const VI = __importStar(__webpack_require__(/*! ./shared/enum-help */ "./React/shared/enum-help.ts"));
exports.VI = VI;
const VII = __importStar(__webpack_require__(/*! ./shared/lists */ "./React/shared/lists.ts"));
exports.VII = VII;
const VIII = __importStar(__webpack_require__(/*! ./shared/top-bar */ "./React/shared/top-bar.tsx"));
exports.VIII = VIII;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.IconButton = exports.IconLabelButton = exports.ActionButton = void 0;
...
exports.ActionButton = action_button_1.default;
const icon_label_button_1 = __importDefault(__webpack_require__(/*! ./components/buttons/icon-label-button */ "./React/shared/components/buttons/icon-label-button.tsx"));
exports.IconLabelButton = icon_label_button_1.default;
const icon_button_1 = __importDefault(__webpack_require__(/*! ./components/buttons/icon-button */ "./React/shared/components/buttons/icon-button.tsx"));
exports.IconButton = icon_button_1.default;
__webpack_require__(/*! ./components/buttons/buttons.css */ "./React/shared/components/buttons/buttons.css");


/***/ }),

/***/ "./React/shared/components/buttons/action-button.tsx":
/*!***********************************************************!*\
  !*** ./React/shared/components/buttons/action-button.tsx ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const ActionButton = (props) => {
    ...
    return (react_1.default.createElement("button", { className: "my-button action-button " + ((_a = props.className) !== null && _a !== void 0 ? _a : ""), onClick: props.onClick, type: type }, props.label));
};
...
/***/ "./React/shared/components/buttons/icon-button.tsx":
/*!*********************************************************!*\
  !*** ./React/shared/components/buttons/icon-button.tsx ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const IconButton = (props) => {
    var _a;
    return (react_1.default.createElement("button", { className: "my-button icon-button " + ((_a = props.className) !== null && _a !== void 0 ? _a : ""), onClick: props.onClick, title: props.label },
        react_1.default.createElement("i", { className: props.faIcon })));
};
...
/***/ "./React/shared/components/buttons/icon-label-button.tsx":
/*!***************************************************************!*\
  !*** ./React/shared/components/buttons/icon-label-button.tsx ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const IconLabelButton = (props) => {
    var _a;
    return (react_1.default.createElement("button", { className: "my-button icon-label-button " +
            ((_a = props.className) !== null && _a !== void 0 ? _a : "") + " " +
            (props.iconSize ? `icon-${props.iconSize}` : "") + " " +
            (props.iconAbove ? 'icon-above' : ""), onClick: props.onClick },
        react_1.default.createElement("i", { className: props.faIcon + " " }),
        props.label));
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.enumAssignSwitch = exports.enumSwitch = exports.isValidEnumValue = exports.getEnumValuesAndNames = exports.getEnumNames = exports.getEnumValues = void 0;
const enum_switch_1 = __webpack_require__(/*! ./enum-help/enum-switch */ "./React/shared/enum-help/enum-switch.ts");
Object.defineProperty(exports, "enumAssignSwitch", ({ enumerable: true, get: function () { return enum_switch_1.enumAssignSwitch; } }));
Object.defineProperty(exports, "enumSwitch", ({ enumerable: true, get: function () { return enum_switch_1.enumSwitch; } }));
...
const getEnumValuesAndNames = (enumClass) => {
    const names = (0, exports.getEnumNames)(enumClass);
    const values = (0, exports.getEnumValues)(enumClass);
    const namesValues = [];
...
exports.getEnumValuesAndNames = getEnumValuesAndNames;
const isValidEnumValue = (enumClass, value) => {
    const values = (0, exports.getEnumValues)(enumClass);
...
/***/ "./React/shared/enum-help/enum-switch.ts":
/*!***********************************************!*\
  !*** ./React/shared/enum-help/enum-switch.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.enumSwitch = exports.enumAssignSwitch = void 0;
const enum_help_1 = __webpack_require__(/*! ../enum-help */ "./React/shared/enum-help.ts");
function enumAssignSwitch(_enum, val, cases) {
    const _case = getCase(_enum, val, cases);
    if (_case instanceof Function)
        return _case();
    return _case;
}
exports.enumAssignSwitch = enumAssignSwitch;
function enumSwitch(_enum, val, cases) {
    enumAssignSwitch(_enum, val, cases);
}
exports.enumSwitch = enumSwitch;
function getCase(_enum, val, cases) {
    var _a;
    let name;
    if (typeof val == 'number') {
        const namesAndVals = (0, enum_help_1.getEnumValuesAndNames)(_enum);
        name = (_a = namesAndVals.find(nameAndVal => nameAndVal.value == val)) === null || _a === void 0 ? void 0 : _a.name;
    }
    else {
        name = val;
    }
    let _case = cases[name];
    if (!_case)
        _case = cases['_'];
    return _case;
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SubmitButton = exports.LabelValue = exports.TextArea = exports.Multiselect = exports.Select = exports.TextInput = exports.Input = void 0;
const input_1 = __importDefault(__webpack_require__(/*! ./form-controls/input */ "./React/shared/form-controls/input.tsx"));
exports.Input = input_1.default;
const select_1 = __importDefault(__webpack_require__(/*! ./form-controls/select */ "./React/shared/form-controls/select.tsx"));
exports.Select = select_1.default;
const multiselect_1 = __importDefault(__webpack_require__(/*! ./form-controls/multiselect */ "./React/shared/form-controls/multiselect.tsx"));
exports.Multiselect = multiselect_1.default;
__webpack_require__(/*! ./form-controls/form-controls.css */ "./React/shared/form-controls/form-controls.css");
const label_value_1 = __importDefault(__webpack_require__(/*! ./form-controls/label-value */ "./React/shared/form-controls/label-value.tsx"));
exports.LabelValue = label_value_1.default;
const text_input_1 = __importDefault(__webpack_require__(/*! ./form-controls/text-input */ "./React/shared/form-controls/text-input.tsx"));
exports.TextInput = text_input_1.default;
const text_area_1 = __importDefault(__webpack_require__(/*! ./form-controls/text-area */ "./React/shared/form-controls/text-area.tsx"));
exports.TextArea = text_area_1.default;
const submit_button_1 = __importDefault(__webpack_require__(/*! ./form-controls/submit-button */ "./React/shared/form-controls/submit-button.tsx"));
exports.SubmitButton = submit_button_1.default;


/***/ }),

/***/ "./React/shared/form-controls/default-error-msg.ts":
/*!*********************************************************!*\
  !*** ./React/shared/form-controls/default-error-msg.ts ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./React/shared/form-controls/input.tsx":
/*!**********************************************!*\
  !*** ./React/shared/form-controls/input.tsx ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const react_1 = __importDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const default_error_msg_1 = __importDefault(__webpack_require__(/*! ./default-error-msg */ "./React/shared/form-controls/default-error-msg.ts"));
const Input = (props) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
    const hasErrors = (_c = (_a = props.hasErrors) !== null && _a !== void 0 ? _a : (_b = props.errorMessages) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : false;
    const hasWarnings = (_d = props.warningMessages) === null || _d === void 0 ? void 0 : _d.length;
    const label = ((_e = props.label) === null || _e === void 0 ? void 0 : _e.length)
        ? react_1.default.createElement("label", { htmlFor: props.name }, props.label)
        : react_1.default.createElement(react_1.default.Fragment, null);
    const onChange = (_f = props.onChange) !== null && _f !== void 0 ? _f : (event => { var _a; return (_a = props.onChangeV) === null || _a === void 0 ? void 0 : _a.call(props, event.target.value); });
    const input = (react_1.default.createElement("input", { className: "form-control" + (hasErrors ? ' is-invalid' : '') + " " + ((_g = props.inputClassName) !== null && _g !== void 0 ? _g : ''), type: props.type, name: props.name, value: (_h = props.value) !== null && _h !== void 0 ? _h : "", onChange: onChange, disabled: props.disabled, checked: props.checked, placeholder: props.placeholder }));
    return (react_1.default.createElement("div", { className: "form-group my-form-group " + ((_j = props.containerClassName) !== null && _j !== void 0 ? _j : '') },
        props.type != 'checkbox'
            ? react_1.default.createElement(react_1.default.Fragment, null,
                label,
                input)
            : react_1.default.createElement(react_1.default.Fragment, null,
                input,
                label),
        hasErrors ? (react_1.default.createElement("div", { className: "invalid-feedback" }, (_k = props.errorMessages) === null || _k === void 0 ? void 0 : _k.map(x => (0, default_error_msg_1.default)(x)).join(' '))) : hasWarnings ? (react_1.default.createElement("div", { className: "invalid-feedback warning-msg" }, (_l = props.warningMessages) === null || _l === void 0 ? void 0 : _l.join(' '))) : undefined));
};
...
/***/ "./React/shared/form-controls/label-value.tsx":
/*!****************************************************!*\
  !*** ./React/shared/form-controls/label-value.tsx ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./React/shared/form-controls/multiselect.tsx":
/*!****************************************************!*\
  !*** ./React/shared/form-controls/multiselect.tsx ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const react_1 = __importDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const select_1 = __importDefault(__webpack_require__(/*! ./select */ "./React/shared/form-controls/select.tsx"));
const Multiselect = (props) => {
    return (react_1.default.createElement(select_1.default, { label: props.label, name: props.name, value: props.value, onChange: props.onChange, onChangeId: props.onChangeId, options: props.options, hasErrors: props.hasErrors, errorMessages: props.errorMessages, warningMessages: props.warningMessages, multiple: true, optionStyle: props.optionStyle }));
};
...
/***/ "./React/shared/form-controls/select.tsx":
/*!***********************************************!*\
  !*** ./React/shared/form-controls/select.tsx ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const default_error_msg_1 = __importDefault(__webpack_require__(/*! ./default-error-msg */ "./React/shared/form-controls/default-error-msg.ts"));
const react_select_1 = __importDefault(__webpack_require__(/*! react-select */ "./node_modules/react-select/dist/react-select.esm.js"));
class Select extends React.Component {
    constructor() {
        ...
        this._styles = {
            option: (provided, props) => {
                var _a, _b, _c;
                return (Object.assign(Object.assign({}, provided), ((_c = (_b = (_a = this.props).optionStyle) === null || _b === void 0 ? void 0 : _b.call(_a, props)) !== null && _c !== void 0 ? _c : {})));
            }
        };
        this.onChange = (values) => {
            var _a, _b, _c, _d, _e, _f;
            (_b = (_a = this.props).onChange) === null || _b === void 0 ? void 0 : _b.call(_a, values);
            if (values instanceof Array)
                (_d = (_c = this.props).onChangeId) === null || _d === void 0 ? void 0 : _d.call(_c, values.map(x => x.value));
            else
                (_f = (_e = this.props).onChangeId) === null || _f === void 0 ? void 0 : _f.call(_e, values.value);
        };
    }
    render() {
        var _a, _b, _c, _d;
        const value = this.prepareValue();
        return (React.createElement("div", { className: "form-group my-form-group " + ((_a = this.props.containerClassName) !== null && _a !== void 0 ? _a : '') },
            this.renderLabel(),
            React.createElement(react_select_1.default, { className: (this._hasErrors || this._hasWarnings ? ' is-invalid' : '') + ((_b = this.props.containerClassName) !== null && _b !== void 0 ? _b : ''), name: this.props.name, value: value, onChange: this.onChange, options: this.props.options, 
                //@ts-ignore
                isMulti: this.props.multiple, styles: this._styles }),
            this._hasErrors ? (React.createElement("div", { className: "invalid-feedback" }, (_c = this.props.errorMessages) === null || _c === void 0 ? void 0 : _c.map(x => (0, default_error_msg_1.default)(x)).join(' '))) : this._hasWarnings ? (React.createElement("div", { className: "invalid-feedback warning-msg" }, (_d = this.props.warningMessages) === null || _d === void 0 ? void 0 : _d.join(' '))) : undefined));
    }
    get _hasErrors() { var _a, _b; return (_a = this.props.hasErrors) !== null && _a !== void 0 ? _a : (_b = this.props.errorMessages) === null || _b === void 0 ? void 0 : _b.length; }
    ;
    get _hasWarnings() { var _a; return (_a = this.props.warningMessages) === null || _a === void 0 ? void 0 : _a.length; }
    prepareValue() {
    ...
    renderLabel() {
        var _a;
        if ((_a = this.props.label) === null || _a === void 0 ? void 0 : _a.length)
            return React.createElement("label", { htmlFor: this.props.name }, this.props.label);
...
/***/ "./React/shared/form-controls/submit-button.tsx":
/*!******************************************************!*\
  !*** ./React/shared/form-controls/submit-button.tsx ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const SubmitButton = (props) => {
    var _a, _b;
    return (react_1.default.createElement("div", { className: "form-group " + (((_a = props.containerClassName) === null || _a === void 0 ? void 0 : _a.length) ? props.containerClassName : "") },
        react_1.default.createElement("input", { type: "submit", value: props.value, className: "form-control " + (((_b = props.inputClassName) === null || _b === void 0 ? void 0 : _b.length) ? props.inputClassName : "") })));
};
...
/***/ "./React/shared/form-controls/text-area.tsx":
/*!**************************************************!*\
  !*** ./React/shared/form-controls/text-area.tsx ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const TextArea = (props) => {
    ...
    const label = ((_e = props.label) === null || _e === void 0 ? void 0 : _e.length)
        ? react_1.default.createElement("label", { htmlFor: props.name }, props.label)
        : react_1.default.createElement(react_1.default.Fragment, null);
    return (react_1.default.createElement("div", { className: "form-group my-form-group " + ((_f = props.containerClassName) !== null && _f !== void 0 ? _f : '') },
        label,
        react_1.default.createElement("textarea", { className: "form-control" + (hasErrors ? ' is-invalid' : '') + " " + ((_g = props.inputClassName) !== null && _g !== void 0 ? _g : ''), name: props.name, value: (_h = props.value) !== null && _h !== void 0 ? _h : "", onChange: ev => props.onChange(ev.target.value), disabled: props.disabled, placeholder: props.placeholder }),
        hasErrors ? (react_1.default.createElement("div", { className: "invalid-feedback" }, (_j = props.errorMessages) === null || _j === void 0 ? void 0 : _j.map(x => (0, default_error_msg_1.default)(x)).join(' '))) : hasWarnings ? (react_1.default.createElement("div", { className: "invalid-feedback warning-msg" }, (_k = props.warningMessages) === null || _k === void 0 ? void 0 : _k.join(' '))) : undefined));
};
...
/***/ "./React/shared/form-controls/text-input.tsx":
/*!***************************************************!*\
  !*** ./React/shared/form-controls/text-input.tsx ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const react_1 = __importDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const input_1 = __importDefault(__webpack_require__(/*! ./input */ "./React/shared/form-controls/input.tsx"));
const TextInput = (props) => {
    const { onChange } = props, reducedProps = __rest(props, ["onChange"]);
    return (react_1.default.createElement(input_1.default, Object.assign({}, reducedProps, { type: "text", onChangeV: props.onChange })));
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ReadonlyList = exports.List = exports.GroupList = void 0;
const group_list_1 = __importDefault(__webpack_require__(/*! ./lists/group-list */ "./React/shared/lists/group-list.tsx"));
exports.GroupList = group_list_1.default;
const list_1 = __importDefault(__webpack_require__(/*! ./lists/list */ "./React/shared/lists/list.tsx"));
exports.List = list_1.default;
const readonly_list_1 = __importDefault(__webpack_require__(/*! ./lists/readonly-list */ "./React/shared/lists/readonly-list.tsx"));
exports.ReadonlyList = readonly_list_1.default;


/***/ }),

/***/ "./React/shared/lists/components/entry-info-component.tsx":
/*!****************************************************************!*\
  !*** ./React/shared/lists/components/entry-info-component.tsx ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const react_1 = __importDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const EntryInfoCopmponent = (props) => {
    return (react_1.default.createElement(react_1.default.Fragment, null,
        props.recordDataKeys.map((key, index) => (react_1.default.createElement("td", { key: index }, props.recordData[key]))),
        props.buttons.map((button, index) => (react_1.default.createElement("td", { className: "dm-ei-row-cell " + button.cellClassName, key: index },
            react_1.default.createElement("button", { className: "dm-ei-row-button " + button.buttonClassName, onClick: () => button.action(props.recordData) }, button.label))))));
};
exports["default"] = EntryInfoCopmponent;


/***/ }),

/***/ "./React/shared/lists/components/list-entry-coponent.tsx":
/*!***************************************************************!*\
  !*** ./React/shared/lists/components/list-entry-coponent.tsx ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const react_1 = __importDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const confirm_close_mod_1 = __importDefault(__webpack_require__(/*! ../help/confirm-close-mod */ "./React/shared/lists/help/confirm-close-mod.tsx"));
const entry_info_component_1 = __importDefault(__webpack_require__(/*! ./entry-info-component */ "./React/shared/lists/components/entry-info-component.tsx"));
class ListEntryComponent extends react_1.default.Component {
    constructor() {
        super(...arguments);
        this._madeAnyChange = false;
        this.onClickedEditBtn = () => __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            if (this._madeAnyChange) {
                const confirmation = yield (0, confirm_close_mod_1.default)();
                if (!confirmation)
                    return;
            }
            this._madeAnyChange = false;
            (_b = (_a = this.props).onOpenEdit) === null || _b === void 0 ? void 0 : _b.call(_a, this.props.recordId, this.props.groupId);
        });
        this.onMadeAnyChange = () => {
            this._madeAnyChange = true;
        };
    }
    get ListEntryInnerComponent() { return this.props.listEntryInnerComponent; }
    get ModificationComponent() { return this.props.modificationComponent; }
    render() {
        var _a, _b, _c, _d, _e, _f;
        const buttons = (_b = (_a = this.props.customButtons) === null || _a === void 0 ? void 0 : _a.map(x => x)) !== null && _b !== void 0 ? _b : [];
        ...
        return (react_1.default.createElement(this.ListEntryInnerComponent, { isEven: this.props.isEven, openedModification: this.props.modifying, columnsCount: ((_d = (_c = this.props.displayProperties) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0) + ((_f = (_e = this.props.customButtons) === null || _e === void 0 ? void 0 : _e.length) !== null && _f !== void 0 ? _f : 0) + 1, entryInfoComponent: react_1.default.createElement(entry_info_component_1.default, { recordData: this.props.recordData, recordDataKeys: this.props.displayProperties, onClickedEditBtn: this.onClickedEditBtn, buttons: buttons }), modificationComponent: this.ModificationComponent ?
                react_1.default.createElement(this.ModificationComponent, { recordId: this.props.recordId, reloadAsync: this.props.reloadAsync, onMadeAnyChange: this.onMadeAnyChange, 
                    //@ts-ignore
                    groupId: this.props.groupId }) : undefined }));
    }
}
exports["default"] = ListEntryComponent;


/***/ }),

/***/ "./React/shared/lists/components/list-entry-inner-component.tsx":
/*!**********************************************************************!*\
  !*** ./React/shared/lists/components/list-entry-inner-component.tsx ***!
  \**********************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const react_1 = __importDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
class ListEntryInnerComponent extends react_1.default.Component {
    render() {
        const modificationRow = this.props.openedModification
            ? (react_1.default.createElement("td", { className: "dm-modification-component-container", colSpan: this.props.columnsCount }, this.props.modificationComponent)) : react_1.default.createElement(react_1.default.Fragment, null);
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("tr", { className: (this.props.isEven ? "even-row" : "") +
                    " data-row" +
                    (this.props.openedModification ? "" : " single-standing-row") }, this.props.entryInfoComponent),
            react_1.default.createElement("tr", { className: this.props.isEven ? "even-row" : "" }, modificationRow),
            react_1.default.createElement("tr", { className: "separation-row" },
                react_1.default.createElement("td", { colSpan: this.props.columnsCount }, " "))));
    }
}
exports["default"] = ListEntryInnerComponent;


/***/ }),

/***/ "./React/shared/lists/components/shared-list-component.tsx":
/*!*****************************************************************!*\
  !*** ./React/shared/lists/components/shared-list-component.tsx ***!
  \*****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
class SharedListComponent extends react_1.default.Component {
    constructor() {
        var _a;
        super(...arguments);
        this._madeAnyChange = false;
        ...
        this.renderColumnSetting = (index, style) => {
            ...
            return react_1.default.createElement("col", { key: index });
        };
        this.ListFundation = (props) => {
            var _a, _b;
            const buttons = (_b = (_a = this.props.customButtons) === null || _a === void 0 ? void 0 : _a.map(x => x.columnStyle)) !== null && _b !== void 0 ? _b : [];
            buttons.push({
                width: '0.1%'
            });
            return (react_1.default.createElement(react_1.default.Fragment, null,
                this.LoaderComponent,
                react_1.default.createElement("table", { className: "dm-list" },
                    ...
                    react_1.default.createElement("thead", null,
                        react_1.default.createElement("tr", null, this.props.columnsSetting.map((setting, i) => react_1.default.createElement("th", { key: i }, setting.header)))),
                    react_1.default.createElement("tbody", null, props.tbody))));
        };
    }
    get ListEntryComponent() { var _a; return (_a = this.props.customListEntryComponent) !== null && _a !== void 0 ? _a : list_entry_coponent_1.default; }
    get ListEntryInnerComponent() { var _a; return (_a = this.props.customListEntryInnerComponent) !== null && _a !== void 0 ? _a : list_entry_inner_component_1.default; }
    get ModificationComponent() { return this.props.modificationComponent; }
    get columnsCount() { var _a, _b, _c, _d; return ((_b = (_a = this.props.columnsSetting) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) + ((_d = (_c = this.props.customButtons) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0) + 1; }
    componentDidMount() {
...
exports["default"] = SharedListComponent;


/***/ }),

/***/ "./React/shared/lists/group-list.tsx":
/*!*******************************************!*\
  !*** ./React/shared/lists/group-list.tsx ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const react_1 = __importDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const shared_list_component_1 = __importDefault(__webpack_require__(/*! ./components/shared-list-component */ "./React/shared/lists/components/shared-list-component.tsx"));
const confirm_close_mod_1 = __importDefault(__webpack_require__(/*! ./help/confirm-close-mod */ "./React/shared/lists/help/confirm-close-mod.tsx"));
class GroupList extends shared_list_component_1.default {
    constructor(props) {
        super(props);
        this.closeAllModCompState = 
        //@ts-ignore
        () => ({ editedRecord: undefined, addingNewOfGroup: undefined });
        this.openOrCloseModification = (id, groupId) => {
            var _a, _b;
            if (id == ((_a = this.state.editedRecord) === null || _a === void 0 ? void 0 : _a.id)
                && groupId == ((_b = this.state.editedRecord) === null || _b === void 0 ? void 0 : _b.groupId))
                this.setState(this.closeAllModCompState);
            else
                this.setState({ editedRecord: { id, groupId }, addingNewOfGroup: undefined });
        };
        this.createOpenOrCloseAddingNewHandler = (groupId) => {
            return () => __awaiter(this, void 0, void 0, function* () {
                if (this._madeAnyChange) {
                    const confirmation = yield (0, confirm_close_mod_1.default)();
                    if (!confirmation)
    ...
    render() {
        ...
        return (react_1.default.createElement(this.ListFundation, { tbody: react_1.default.createElement(react_1.default.Fragment, null, (_a = this.state.data) === null || _a === void 0 ? void 0 : _a.map((group) => {
                var _a, _b;
                return react_1.default.createElement(react_1.default.Fragment, { key: group.id },
                    group.name != undefined
                        ?
                            react_1.default.createElement(react_1.default.Fragment, null,
                                react_1.default.createElement("tr", { className: "group-header-row" },
                                    react_1.default.createElement("th", { colSpan: this.props.columnsSetting.length + 1 }, group.name)),
                                react_1.default.createElement("tr", { className: "separation-row" },
                                    react_1.default.createElement("td", { colSpan: this.props.columnsSetting.length + 1 })))
                        : react_1.default.createElement(react_1.default.Fragment, null), (_a = group.entries) === null || _a === void 0 ? void 0 :
                    _a.map((entry, entryIndex) => {
                        var _a, _b, _c, _d;
                        return react_1.default.createElement(this.ListEntryComponent, { key: `${entry.id}${entryIndex}`, recordId: entry.id, groupId: group.id, recordData: entry, modificationComponent: this.ModificationComponent, listEntryInnerComponent: this.ListEntryInnerComponent, modifying: entry.id == ((_b = (_a = this.state) === null || _a === void 0 ? void 0 : _a.editedRecord) === null || _b === void 0 ? void 0 : _b.id) && group.id == ((_d = (_c = this.state) === null || _c === void 0 ? void 0 : _c.editedRecord) === null || _d === void 0 ? void 0 : _d.groupId), displayProperties: displayProperties, onOpenEdit: this.openOrCloseModification, reloadAsync: this.loadAsync, isEven: entryIndex % 2 == 1, customButtons: this.props.customButtons });
                    }),
                    react_1.default.createElement(this.ListEntryInnerComponent, { isEven: ((_b = group.entries) === null || _b === void 0 ? void 0 : _b.length) % 2 == 1, openedModification: this.state.addingNewOfGroup == group.id, columnsCount: this.columnsCount, entryInfoComponent: react_1.default.createElement("td", { className: "dm-ei-row-cell", colSpan: this.columnsCount },
                            react_1.default.createElement("button", { className: "dm-ei-row-button", onClick: this.createOpenOrCloseAddingNewHandler(group.id) }, "Dodaj")), modificationComponent: react_1.default.createElement(this.ModificationComponent, { recordId: undefined, reloadAsync: this.loadAsync, onMadeAnyChange: this.onMadeAnyChange, groupId: group.id }) }));
            })) }));
    }
}
...
/***/ "./React/shared/lists/help/confirm-close-mod.tsx":
/*!*******************************************************!*\
  !*** ./React/shared/lists/help/confirm-close-mod.tsx ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const confirmCloseMod = () => __awaiter(void 0, void 0, void 0, function* () {
...
exports["default"] = confirmCloseMod;


/***/ }),

/***/ "./React/shared/lists/list.tsx":
/*!*************************************!*\
  !*** ./React/shared/lists/list.tsx ***!
  \*************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const shared_list_component_1 = __importDefault(__webpack_require__(/*! ./components/shared-list-component */ "./React/shared/lists/components/shared-list-component.tsx"));
const confirm_close_mod_1 = __importDefault(__webpack_require__(/*! ./help/confirm-close-mod */ "./React/shared/lists/help/confirm-close-mod.tsx"));
class List extends shared_list_component_1.default {
    constructor(props) {
        super(props);
        this.closeAllModCompState = 
        //@ts-ignore
        () => ({ editedRecordId: undefined, addingNew: false });
        this.openOrCloseModification = (id) => {
            if (id == this.state.editedRecordId)
                this.setState(this.closeAllModCompState);
            else
                this.setState({ editedRecordId: id, addingNew: false });
        };
        this.openOrCloseAddingNew = () => __awaiter(this, void 0, void 0, function* () {
            if (this._madeAnyChange) {
                const confirmation = yield (0, confirm_close_mod_1.default)();
                if (!confirmation)
                    return;
    ...
    render() {
        var _a, _b;
        const displayProperties = this.props.columnsSetting.map(x => x.prop);
        return (react_1.default.createElement(this.ListFundation, { tbody: react_1.default.createElement(react_1.default.Fragment, null, (_a = this.state.data) === null || _a === void 0 ? void 0 :
                _a.map((data, i) => {
                    var _a;
                    const recordId = data.id;
                    return (react_1.default.createElement(this.ListEntryComponent, { key: i, recordId: recordId, recordData: data, modificationComponent: this.ModificationComponent, listEntryInnerComponent: this.ListEntryInnerComponent, customButtons: this.props.customButtons, modifying: recordId == ((_a = this.state) === null || _a === void 0 ? void 0 : _a.editedRecordId), displayProperties: displayProperties, onOpenEdit: this.openOrCloseModification, reloadAsync: this.loadAsync, isEven: i % 2 == 1 }));
                }),
                react_1.default.createElement(this.ListEntryInnerComponent, { isEven: ((_b = this.state.data) === null || _b === void 0 ? void 0 : _b.length) % 2 == 1, openedModification: this.state.addingNew, columnsCount: this.columnsCount, entryInfoComponent: react_1.default.createElement("td", { className: "dm-ei-row-cell", colSpan: this.columnsCount },
                        react_1.default.createElement("button", { className: "dm-ei-row-button", onClick: this.openOrCloseAddingNew }, "Dodaj")), modificationComponent: react_1.default.createElement(this.ModificationComponent, { recordId: undefined, reloadAsync: this.loadAsync, onMadeAnyChange: this.onMadeAnyChange }) })) }));
    }
}
...
/***/ "./React/shared/lists/readonly-list.tsx":
/*!**********************************************!*\
  !*** ./React/shared/lists/readonly-list.tsx ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const react_1 = __importDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const shared_list_component_1 = __importDefault(__webpack_require__(/*! ./components/shared-list-component */ "./React/shared/lists/components/shared-list-component.tsx"));
class ReadonlyList extends shared_list_component_1.default {
    constructor(props) {
        super(props);
        this.closeAllModCompState = 
        //@ts-ignore
    ...
    render() {
        var _a;
        const displayProperties = this.props.columnsSetting.map(x => x.prop);
        return (react_1.default.createElement(this.ListFundation, { tbody: react_1.default.createElement(react_1.default.Fragment, null, (_a = this.state.data) === null || _a === void 0 ? void 0 : _a.map((data, i) => {
                const recordId = data.id;
                return (react_1.default.createElement(this.ListEntryComponent, { key: i, recordId: recordId, recordData: data, listEntryInnerComponent: this.ListEntryInnerComponent, customButtons: this.props.customButtons, modifying: false, displayProperties: displayProperties, reloadAsync: this.loadAsync, isEven: i % 2 == 1 }));
            })) }));
    }
}
exports["default"] = ReadonlyList;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CustomComponentModal = exports.ConfirmationModal = exports.Modal = exports.ModalSpace = exports.modalController = void 0;
const modal_controller_1 = __importStar(__webpack_require__(/*! ./modals/modal-controller */ "./React/shared/modals/modal-controller.tsx"));
exports.modalController = modal_controller_1.default;
Object.defineProperty(exports, "ModalSpace", ({ enumerable: true, get: function () { return modal_controller_1.ModalSpace; } }));
const modal_1 = __importDefault(__webpack_require__(/*! ./modals/modal */ "./React/shared/modals/modal.tsx"));
exports.Modal = modal_1.default;
const confirmation_modal_1 = __importDefault(__webpack_require__(/*! ./modals/confirmation-modal */ "./React/shared/modals/confirmation-modal.tsx"));
exports.ConfirmationModal = confirmation_modal_1.default;
const custom_component_modal_1 = __importDefault(__webpack_require__(/*! ./modals/custom-component-modal */ "./React/shared/modals/custom-component-modal.tsx"));
exports.CustomComponentModal = custom_component_modal_1.default;
__webpack_require__(/*! ./modals/modals.css */ "./React/shared/modals/modals.css");


/***/ }),

/***/ "./React/shared/modals/confirmation-modal.tsx":
/*!****************************************************!*\
  !*** ./React/shared/modals/confirmation-modal.tsx ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
class ConfirmationModal extends React.Component {
    ...
    render() {
        return (React.createElement(shared_modal_body_1.ModalBody, { assignedAtPresenter: this.props.assignedAtPresenter, style: this.props.style },
...
/***/ "./React/shared/modals/custom-component-modal.tsx":
/*!********************************************************!*\
  !*** ./React/shared/modals/custom-component-modal.tsx ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const React = __importStar(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const shared_modal_body_1 = __webpack_require__(/*! ./shared-modal-body */ "./React/shared/modals/shared-modal-body.tsx");
class CustomComponentModal extends React.Component {
    render() {
        return (React.createElement(shared_modal_body_1.ModalBody, { assignedAtPresenter: this.props.assignedAtPresenter, style: this.props.style },
            React.createElement(this.props.modificationComponent, Object.assign({}, this.props.modificationComponentProps, { assignedAtPresenter: this.props.assignedAtPresenter }))));
    }
}
exports["default"] = CustomComponentModal;


/***/ }),

/***/ "./React/shared/modals/modal-controller.tsx":
/*!**************************************************!*\
  !*** ./React/shared/modals/modal-controller.tsx ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ModalSpace = void 0;
const react_1 = __importDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const confirmation_modal_1 = __importDefault(__webpack_require__(/*! ./confirmation-modal */ "./React/shared/modals/confirmation-modal.tsx"));
const modal_1 = __importDefault(__webpack_require__(/*! ./modal */ "./React/shared/modals/modal.tsx"));
const custom_component_modal_1 = __importDefault(__webpack_require__(/*! ./custom-component-modal */ "./React/shared/modals/custom-component-modal.tsx"));
const modal_presenter_1 = __importDefault(__webpack_require__(/*! ./modal-presenter */ "./React/shared/modals/modal-presenter.tsx"));
class ModalController {
    constructor() {
        this._modalSpaceRef = react_1.default.createRef();
    }
    ...
    add(props) {
        ...
        this._modalPresenter.addModal(react_1.default.createElement(modal_1.default, Object.assign({ key: id, assignedAtPresenter: {} }, props)), id);
        return id;
    }
    addConfirmation(props) {
        const id = this.newUniqueId;
        this._modalPresenter.addModal(react_1.default.createElement(confirmation_modal_1.default, Object.assign({ key: id, assignedAtPresenter: {} }, props)), id);
        return id;
    }
    addCustom(modal) {
        const id = this.newUniqueId;
    ...
    addCustomComponent(props) {
        const id = this.newUniqueId;
        this._modalPresenter.addModal(react_1.default.createElement(custom_component_modal_1.default, Object.assign({ key: id, assignedAtPresenter: {} }, props)), id);
        return id;
    }
    closeById(id) {
...
ModalController._uniqueIdCounter = 0;
const modalController = new ModalController;
exports["default"] = modalController;
class ModalSpace extends react_1.default.Component {
    constructor(props) {
        super(props);
        this._thisSpaceIsValid = false;
    ...
    render() {
        if (!this._thisSpaceIsValid)
            return react_1.default.createElement(react_1.default.Fragment, null);
        return (react_1.default.createElement(modal_presenter_1.default, { ref: modalController.modalSpaceRef }));
    }
}
exports.ModalSpace = ModalSpace;
ModalSpace._validSpaceAlreadyExists = false;


/***/ }),

/***/ "./React/shared/modals/modal-presenter.tsx":
/*!*************************************************!*\
  !*** ./React/shared/modals/modal-presenter.tsx ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
class ModalPresenter extends React.Component {
    constructor(props) {
        ...
        this.setOnCloseAction = (uniqueId, onClose) => {
            var _a;
            const modal = (_a = this.state.modals) === null || _a === void 0 ? void 0 : _a.find(x => { var _a; return ((_a = x.component.props.assignedAtPresenter) === null || _a === void 0 ? void 0 : _a.uniqueId) == uniqueId; });
            if (!modal)
                return;
    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "modal-background" },
                React.createElement("div", { className: "modal-bg-scroll" },
                    React.createElement("div", { className: "modal-dismiss-listener", onClick: this.removeLastModal }),
...
class Modal extends React.Component {
    render() {
        return (React.createElement(shared_modal_body_1.ModalBody, { assignedAtPresenter: this.props.assignedAtPresenter, style: this.props.style }, this.props.children));
    }
}
...
/***/ "./React/shared/modals/shared-modal-body.tsx":
/*!***************************************************!*\
  !*** ./React/shared/modals/shared-modal-body.tsx ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const ModalBody = (props) => {
    const close = () => {
        var _a;
        (_a = props.assignedAtPresenter) === null || _a === void 0 ? void 0 : _a.close();
    };
    return (React.createElement("div", { className: "modal-container", style: props.style },
        React.createElement("a", { className: "modal-close-btn", style: props.closeBtnStyle, onClick: close },
...
/***/ "./React/shared/server-connection.tsx":
/*!********************************************!*\
  !*** ./React/shared/server-connection.tsx ***!
  \********************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const react_1 = __importDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
__webpack_require__(/*! ./top-bar.css */ "./React/shared/top-bar.css");
class TopBarImpl extends react_1.default.Component {
    constructor(props) {
        super(props);
        this._renderBar = () => {
            const style = {
        ...
        this._renderGoBackBtn = () => (react_1.default.createElement("button", { className: "top-bar-go-back-btn", onClick: () => this._goBack() }, "Wr\u00F3\u0107"));
        this.NAVBAR_BOTTOM_MARGIN = 16;
    }
    render() {
        return (react_1.default.createElement("div", { className: "top-bar-container" }, this._renderBar()));
    }
...
class TopBar extends react_1.default.Component {
    render() {
        return (react_1.default.createElement(TopBarImpl, Object.assign({ ref: ref => TopBar.Ref = ref }, this.props)));
    }
}
...
class Validator {
    ...
    validate() {
        if (this._modelGetter)
            this._model = this._modelGetter();
        if (!this._model)
            return false;
        this._errors = [];
        const properties = Object.keys(this._rules);
    ...
    validateOther(prop, other) {
        if (other instanceof Array) {
            for (const otherRule of other !== null && other !== void 0 ? other : []) {
            ...
            const otherError = other === null || other === void 0 ? void 0 : other(this._model, prop);
            if (otherError) {
    ...
    useSubValidator(prop, getRules) {
        if (!this._subValidators[prop]) {
            this._subValidators[prop] = new Validator();
            this._subValidators[prop].setRules(getRules(() => this._model, prop));
        }
        this._subValidators[prop].forModel(this._model[prop]);
        this._subValidators[prop].validate();
    }
    addErrorInner(prop, defaultMsg, rulesProp) {
        let error;
...
/******/ __webpack_require__.O(0, ["vendor"], () => (__webpack_exec__("./React/shared.ts")));
